...
Here we are discussing Lomuto Partition Algorithm with the rightmost element being the pivot
...
P3 - P1 - P2  =  (Xl+Xr)(Yl+Yr) - Xl×Yl - Xr×Yr =  Xl×Yr + Xr×Yl        <= the middle terms
